...
export const QUESTIONS = [
  ...
  },
  {
    id: "q2",
    dim: "S1",
    text: "我不只是屌丝，我还是 joker，是咸鱼，是情绪一上来就想自嘲的小丑。别人青春里有恋爱、有并肩走路、有周末约会，我的青春像在替别人做背景板。读着不喜欢的学校，花着家里的钱，没理想、没目标、没本事，越活越像躲在角落里偷看别人幸福的老鼠。每次别人拿屌丝开玩笑，我都感觉自己又被补了一刀，甚至已经想象到今晚要把枕巾哭湿一大片。",
    options: [
      { label: "我哭了。。", value: 1 },
      { label: "这是什么。。", value: 2 },
      { label: "这不是我！", value: 3 },
  ...
  },
  {
    id: "q10",
    dim: "E2",
    text: "你的恋爱对象是一个近乎完美的人：尊老爱幼、勤奋上进、温柔善良、情绪稳定、会说话、见过世面，而且长得还特别好看。此时你会？",
    options: [
  ...
  },
  {
    id: "q14",
    dim: "A1",
    text: "你走在街上，一位萌到离谱的小女孩蹦蹦跳跳地朝你走来，正脸萌、侧脸萌，拿 vivo、苹果、华为、OPPO 看都萌，最后递给你一根棒棒糖。此时你作何感想？",
    options: [
  ...
  },
  {
    id: "q15",
    dim: "A2",
    text: "快考试了，学校规定必须上晚自习，请假还会扣分，但今晚你已经约了女/男神一起玩《绝地求生：刺激战场》（一款刺激的游戏）。你怎么办？",
    options: [
  ...
  },
  {
    id: "q18",
    dim: "A3",
    text: "突然某一天，我意识到人生哪有什么狗屁意义。人好像只是被食欲、困意和荷尔蒙推着走的生物，吃饱、睡觉、发情、再继续重复，和别的动物相比也未必高贵到哪里去。",
    options: [
      { label: "是这样的。", value: 1 },
  ...
  },
  {
    ...
    options: [
      { label: "再坚持半小时，说不定下一秒就有了。", value: 1 },
      { label: "边拍屁股边催自己：快点啊，给我争口气。", value: 2 },
      { label: "直接上开塞露，先把问题解决再说。", value: 3 },
    ],
  },
  {
    id: "q21",
  ...
  },
  {
    id: "q25",
    dim: "So1",
    text: "你因玩《第五人格》（一款刺激的游戏）结识了许多网友，并被邀请线下见面。此时你的想法是？",
    options: [
...
export const SPECIAL_QUESTIONS = [
  ...
  },
  {
    ...
    options: [
      ...
      { label: "我习惯把白酒装进保温杯，当白开水一样喝，酒精让我十分信服。", value: 2 },
    ],
  },
];
